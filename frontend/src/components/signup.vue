            ...
            <form   @submit="checkForm" id="signup" action="" method="">
               ...
               <p v-if="errors.length" class="text-warning">
                ...
                <div class="form-group col ">
                    ...
                    <input class="form-control color pl-5 p-4 "  name="lastname" type="text" v-model.trim="lastname" placeholder="Lastname" required/>
                    <i class="fa fa fa-user fa-fw " ></i>
                </div>
                <div class="form-group col">
                    <label for="firstname"></label>
                    <input class="form-control color pl-5 p-4" name="firstname" type="text" v-model.trim="firstname" placeholder="firstname" required/>
                    <i class="fa fa fa-user fa-fw " aria-hidden="true"></i>
                </div>
                <div class="form-group col">
                    <label for="role"></label>
                    <input class="form-control color pl-5 p-4"  name="role" type="text" v-model.trim="role" placeholder="role" required/>
                    <i class="fa fa fa-suitcase fa-fw " aria-hidden="true"></i>
                </div>
                <div class="form-group col">
                    <label for="email"></label>
                    <input class="form-control color pl-5 p-4"  name="email" type="email" v-model.trim="email" placeholder="email" required/>
                    <i class="fa fa fa-at fas-fw" aria-hidden="true"></i>
                </div>
                <div class="form-group col">
                    <label for="password"></label>
                    <input class="form-control color pl-5 p-4" v-model.trim="password" name="password" type="password" placeholder="password" required/>
                    <i class="fa fa fa-lock fa-fw " aria-hidden="true"></i>
                </div>
               <button class="login__btn color col-lg-4 col-7 text-white m-5 shadow-lg" type="submit">  S'inscrire </button>
            </form>
        </div>
...
export default {
   ...
   data () {
    ...
    methods:{
        ...
        this.errors = [];
        if (!regex.test(this.lastname) || !regex.test(this.firstname) || !regex.test(this.role)) {
            this.errors.push('Format incorrect !');
