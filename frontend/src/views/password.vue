...
<!-- Modification du mot de passe -->
   <section class=" color col-lg-6 col-md-6 mx-auto text-center shadow-lg border border-primary rounded-lg mt-5">
      <h1 class="h1 display-5 text-center "> Groupomania </h1> 
       ...
       <div class="white">
            <form 
            @submit="changePass" class="needs-validation "
            action=''
            method="put">
                ...
                <div class="form-group  col">
                    ...
                    <input class="form-control color pl-5 p-4" name="pass"
                    v-model="pass" type="password" placeholder="new password" required/>
                ...
                <div class="form-group  col">
                    ...
                    v-model="password" type="password" placeholder="new password" required/>
                    <i class="fa fa fa-lock fa-fw " aria-hidden="true"></i>
                </div>
                <button 
                class="sub_btn col-lg-4 col-7 white color m-5 " type="submit"
                > Valider  
                </button>
            </form>
        </div>
